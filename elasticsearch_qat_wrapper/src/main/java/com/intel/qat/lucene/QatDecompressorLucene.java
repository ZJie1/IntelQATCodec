 ...
 * @link qat-parent
 */
public class QatDecompressorLucene {
    private static final Logger LOG = LogManager.getLogger(QatDecompressorLucene.class);

    private static final int DEFAULT_DIRECT_BUFFER_SIZE = 640 * 1024;

    // HACK - Use this as a global lock in the JNI layer
    @SuppressWarnings({"rawtypes"})
    private static Class clazz = QatDecompressorLucene.class;
    ...
    static {
        if (nativeCodeLoader.isNativeCodeLoaded() &&
            ...
            try {
                QatCompressorDecompressorJNI.initIDsNoLevel();
     ...
     * @param numa
     */
    public QatDecompressorLucene(int directBufferSize, boolean useNativeAllocateBB,
     ...
     */
    public QatDecompressorLucene(int directBufferSize) {
    ...
    public int decompress(byte[] b, int off, int len)
        ...
        if (compressedDirectBufLen > 0) {
            ...
            // Decompress data
            n = QatCompressorDecompressorJNI.decompressBytesDirect();
